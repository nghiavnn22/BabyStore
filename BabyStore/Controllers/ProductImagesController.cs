...
namespace BabyStore.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public ActionResult Upload(HttpPostedFileBase[] files)
        {
            ...
            {
                ModelState.AddModelError("FileName", "Plase choose a file");
            }
            if (ModelState.IsValid)
            {
                ...
                if (duplicates)
                {
                    ModelState.AddModelError("FileName","All files uploaded except the files"+
                        duplicateFiles+", which already exits in the system."+ "Please delete them and try again if you wish to re-add them");
                    return View();
                }
                else if (otherDbError)
                {
                    ModelState.AddModelError("FileName", "Sorry an error has occurred saving to the database, plase try again");
                    return View();
                }
